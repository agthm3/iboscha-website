    ...
    <div class="container">
        <div class="left pull-left">
            <ul>
                ...
                <li><a href="blog-single.html">News</a></li>
                <li><i class="fa fa-caret-right" aria-hidden="true"></i></li>
                <li>News Single</li>
            </ul>    
        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="tag pull-left">
                                            <p><span>Tags:</span> Repair, Processor, LED Screen</p>
                                        </div>
